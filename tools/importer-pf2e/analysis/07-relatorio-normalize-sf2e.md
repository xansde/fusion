# 07 — Relatório de Normalização SF2E → Formato Intermediário Fusion

> Gerado em: 2026-07-05
> Script: `src/normalize.mjs --system sf2e`
> Estágio: EXTRACT/NORMALIZE (M2-P / M4)

## 0. Allowlist de traits SF2e-exclusivos (REQ-SF2-044/047)

O importer não rejeita nenhum trait desconhecido (traits são passthrough
livre desde o pf2e); esta tabela apenas documenta cobertura observada da
allowlist de traits SF-exclusivos contra os packs processados nesta run.

| Trait | Observado nos packs processados |
|---|---|
| `alien` | — não |
| `analog` | ✅ sim |
| `android` | — não |
...
|---|---|---|---|---|---|---|---|
| **equipment** | 538 | 538 | 352 | 186 | 142 | 234 | 0 |
| **spells** | 159 | 159 | 116 | 43 | 1 | 1 | 0 |
| **conditions** | 3 | 3 | 2 | 1 | 3 | 8 | 0 |
| **alien-core-bestiary** | 247 | 3240 | 2853 | 387 | 296 | 460 | 2993 |
| **rulebook-bestiaries** | 46 | 110 | 110 | 0 | 0 | 0 | 64 |
| **TOTAL** | **993** | **4050** | **3433** | **617** | **442** | **703** | **3057** |
...
|---|---|---|
| equipment | 538 | ~0.71 MB |
| spells | 159 | ~0.28 MB |
| conditions | 3 | ~0.00 MB |
| alien-core-bestiary | 247 | ~3.31 MB |
| rulebook-bestiaries | 46 | ~0.10 MB |
