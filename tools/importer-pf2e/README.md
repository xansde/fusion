...
| `armor-core`          |   12 | Player Core ∪ Player Core 2 armor, categories unarmored/light/medium/heavy only, mundane (no `magical`/`invested` traits) (r28/A1).                                                                             |
| `shields-core`        |    4 | Player Core ∪ Player Core 2 basic shields (Buckler, Wooden/Steel/Tower Shield), mundane only (r28/A1).                                                                                                           |
