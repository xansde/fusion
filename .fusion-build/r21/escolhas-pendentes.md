...
_"a correção foi apenas na ancestralidade adotada? não tem uma verificação para ver se
existem outros casos similares?"_ — não tinha. Agora tem: `choiceSetInventory.ts` +
