...
| **T0.3**  | **Converter o namespace das 350 regras `GrantItem`** (de 471 no total) que apontam para `Compendium.pf2e.*`, para o `_id` local — no importer + regeneração dos packs                                                                                                                                                                                                                                                                                                                                | código do importador: **`external/fusion-systems-2e/tools/importer-pf2e/src/`** (o `tools/importer-pf2e/` da raiz do core é **outro diretório**, untracked, só com dado — ver T5.0); packs `{class-features,feats}-core` | ⇠ T0.1       |
| **T0.3b** | Registrar como **issue separada** os ~5.805 links `@UUID` apontando para `Compendium.pf2e.*` na **prosa das descrições** — link quebrado no texto, não concessão morta. Fora do escopo desta fatia.                                                                                                                                                                                                                                                                                                  | satélite                                                                                                                                                                                                                 | ⇠ T0.3       |
| **T0.4**  | Validador de integridade: falhar o build do pack se sobrar `GrantItem` apontando para UUID não resolvível                                                                                                                                                                                                                                                                                                                                                                                            | `tools/importer-pf2e/`                                                                                                                                                                                                   | ⇠ T0.3       |
