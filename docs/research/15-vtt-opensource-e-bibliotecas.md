...
- **Atenção:** o VTT precisa de um servidor HTTP/WebSocket para que players conectem pelo browser — isso é uma restricão importante. O servidor Node.js deve rodar _separadamente_ do processo Tauri, ou Tauri deve expor uma porta ao localhost.
