...
Escopo: os **1588 requisitos [MVP]** definidos nas 39 specs. Os [V2] ficam de fora
...
| --- | ---: | ---: |
| Citados por algum teste | 218 | 14% |
| Citados só por código de produção | 330 | 21% |
| Sem nenhuma citação | 1040 | 65% |
| **Total [MVP]** | **1588** | |
