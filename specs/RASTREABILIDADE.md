...
Escopo: os **1706 requisitos [MVP]** definidos nas 41 specs. Os [V2] ficam de fora
...
| --- | ---: | ---: |
| Citados por algum teste | 218 | 13% |
| Citados só por código de produção | 330 | 19% |
| Sem nenhuma citação | 1158 | 68% |
| **Total [MVP]** | **1706** | |
