...
| --- | ---: | ---: |
| Citados por algum teste | 615 | 33% |
| Citados só por código de produção | 328 | 17% |
| Sem nenhuma citação | 948 | 50% |
| **Total [MVP]** | **1891** | |
