...
| Spec | O que muda                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `16` | **REQ-CMP-013** passa a ter irmã: além da busca dentro do pack, o servidor DEVE oferecer busca **sobre todos os packs visíveis ao solicitante** (DEC-CPD-02, REQ-CPD-030). **O manifesto do pack ganha `audience`** (DEC-CPD-04, REQ-CPD-070), ao lado de `license`. O **overlay de nome traduzido**, que já existe em produção e não estava em spec, passa a ser exigência de exibição e de busca (DEC-CPD-06). _Aplicada em 2026-08-16: REQ-CMP-004a (plateia no manifesto, ausência = `all`), REQ-CMP-010a (plateia imposta no servidor), REQ-CMP-013a (busca agregada), REQ-CMP-007a/012a/013b (dois nomes no índice, na exibição e na busca), CA-CMP-14/15._ |
...
| `17` | Os packs de criaturas e perigos publicados pelo sistema PF2e passam a nascer com `audience: "gm"` (REQ-CPD-072). É mudança de publicação, não de conteúdo. _Aplicada em 2026-08-16: REQ-PF2-140 (`audience` no manifesto de todo pack), REQ-PF2-141 (criaturas `gm`), REQ-PF2-142 (perigos `gm`, prospectivo — o sistema ainda não publica pack de perigos), REQ-PF2-143 (demais packs `all`), REQ-PF2-144 (proibido compensar a plateia mexendo no conteúdo) e REQ-PF2-145 (trocar plateia é edição de manifesto)._                                                                                                                                              |
