...
| Spec | O que muda                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `08` | **REQ-ROL-006** troca a notação de explosão. O motor embarcado (`@dice-roller/rpg-dice-roller` 5.5.x — o mesmo parser que o servidor executa e que valida favorito) **recusa** `x` e `xo`: os dois exemplos da spec, `3d6x` e `6d10xo10`, não parseiam. A notação que o motor aceita é `!` (explode ilimitado), `!!` (composto) e `!p` (penetrante), com comparador na forma `!>=10` (número solto, `!10`, também é recusado). "Explode uma vez" (`xo`) **não tem equivalente** no motor embarcado e fica sem cobertura até a `08` decidir entre remover a variante ou trocar de motor. A janela de montagem (REQ-ACH-060) compõe `!`. |
