...
- `06` — dona da cena e da ativação: initial view (REQ-CNV-068), parâmetros de ambiente
  (REQ-CNV-069), navegar e ativar (REQ-CNV-070), preload [V2] (REQ-CNV-071).
...
| Spec | O que muda                                                                                                                                                                                                                                                                                                                                                 |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `06` | **REQ-CNV-070** ("o cliente DEVE permitir navegar entre cenas e ativar uma cena") passa a ter as duas metades separadas por esta spec: **ativar** é global, com escritor único e recusa no caminho genérico (DEC-CEN-02, REQ-CEN-041/042); **navegar** sem ativar existe apenas como preparo local do Mestre (DEC-CEN-03), não como navegação por usuário. |
