...
| Spec | O que muda                                                                                                                                                                                                                                                                                                                                                  |
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `10` | **REQ-CBT-041** pede que cada linha do tracker exiba o valor de iniciativa e o HP. Passa a valer, para esta aba: iniciativa **só na montagem** (DEC-CBA-04) e vida **conforme o papel** (DEC-CBA-03). **REQ-CBT-040** ("aba da sidebar") é concretizado por esta spec. **REQ-CBT-053..055** (targeting) continuam válidos, mas fora do painel (DEC-CBA-05). |
