 ...
 * returns exactly the committed packs under systems/sf2e/packs/ (18 after the
 * Player Core SF2e curation, PR #169/#171 — this test started as "exactly 6"
 * before that curation landed; the number grows, the invariant it proves
 * does not).
 *
...
// ---------------------------------------------------------------------------
// Expected committed packs (systems/sf2e/packs/) — exactly these, kept in
// sync with the pack directory by hand (curation adds packs; this list is
// the regression check, not a generator).
// ---------------------------------------------------------------------------
